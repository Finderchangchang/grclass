...
class VideoFragment() : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val teacher_name_tv = view.findViewById(R.id.teacher_name_tv) as TextView
        val teacher_detail_tv = view.findViewById(R.id.teacher_detail_tv) as TextView
        val desc_tv = view.findViewById(R.id.desc_tv) as TextView
        val yxq_tv = view.findViewById(R.id.yxq_tv) as TextView//有效期
        val ks_tv = view.findViewById(R.id.ks_tv) as TextView//课时
        val bf_tv = view.findViewById(R.id.bf_tv) as TextView//播放次数
        val ml_lv_fl = view.findViewById(R.id.ml_lv_fl) as FrameLayout//评论列表
