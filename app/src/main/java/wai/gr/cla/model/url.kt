...
/**
 * Created by Finder丶畅畅 on 2017/5/13 00:56
 * QQ群481606175
 */
class url {
    //val total = "http://gr.rungo.net"
    val total="http://test.guanrenjiaoyu.com"
    val normal = "http://test.guanrenjiaoyu.com/?s=index/"
    val public_api = normal + "api/"
    val class_api = normal + "course/"
    val user_api = normal + "user/"
    val auth_api = normal + "auth_api/"
    val wx_api = normal + "wxpay/"
    val pay_api = normal + "pay/"
}