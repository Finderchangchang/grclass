...
class ZBFragment : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val alphaIndicator = view.findViewById(R.id.alphaIndicator) as AlphaTabsIndicator
        val tab1_tv = view.findViewById(R.id.tab1_tv) as TextView
        audition_tv = view.findViewById(R.id.audition_tv) as TextView
        val tab2_tv = view.findViewById(R.id.tab2_tv) as TextView
        val tab3_tv = view.findViewById(R.id.tab3_tv) as TextView
        val tab4_tv = view.findViewById(R.id.tab4_tv) as TextView
...
//        val zl_ll = view.findViewById(R.id.zl_ll) as LinearLayout
        ...
        val gg_class_gv = view.findViewById(R.id.gg_class_gv) as GridView
        val tv1 = view.findViewById(R.id.tv1) as TextView
        val tv2 = view.findViewById(R.id.tv2) as TextView
        val tv3 = view.findViewById(R.id.tv3) as TextView
